                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <label class=" control-label">
                                                      <input type="radio" name="environment" value="Maintenance" class="flat-red" @if($result['commonContent']['setting']['environmentt'] == 'Maintenance') checked @endif > &nbsp;{{ trans('labels.Maintenance') }}
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                <label class=" control-label">
                                                      <input type="radio" name="environment" value="production" class="flat-red" @if($result['commonContent']['setting']['environmentt'] == 'production') checked @endif >  &nbsp;{{ trans('labels.production') }}
                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                <label class=" control-label">
                                                      <input type="radio" name="environment" value="local" class="flat-red" @if($result['commonContent']['setting']['environmentt'] == 'local') checked @endif >  &nbsp;{{ trans('labels.local') }}
                                                </label>
                                            </div>
                                        </div>
