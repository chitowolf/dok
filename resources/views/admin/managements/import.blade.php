...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Import Data') }} <small>{{ trans('labels.Import Data') }}...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li class="active">{{ trans('labels.Import Data') }}</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.Import Data') }}</h3>
                        </div>
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group" id="imageIcone">
                                                ...
                                                <p class="col-sm-10 col-md-4">{{ trans('labels.Text for import zip file') }}</p>
                                            </div>
